...
def init_game_world():
    """
    Initializes the game world (map + players + units + pathfinding + AI).
    Returns:
    ...
    # These dicts are owned by main, but units/player reference them via context
    # (main will overwrite them right after import if needed)
