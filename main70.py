    ...
    if game_state == GameState.RUNNING:
        ...
        if placing_building and building_pos:
            ...
            if image:
                ...
                preview_surface = pygame.Surface((building_to_place.size, building_to_place.size), pygame.SRCALPHA)
                preview_surface.fill(temp_building.color[:3] + (128,))
                screen.blit(preview_surface, (x - building_to_place.size / 2, y - building_to_place.size / 2))
            ...
            pygame.draw.rect(screen, border_color, (snapped_x - building_to_place.size / 2, snapped_y - building_to_place.size / 2, building_to_place.size, building_to_place.size), 2)
