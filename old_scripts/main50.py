...
class WaypointGraph:
    ...
    def is_walkable(self, tile_x, tile_y, unit):
        ...
        nearby_units = self.spatial_grid.get_nearby_units(unit, radius=self.tile_size)
    ...
    def get_neighbors(self, tile_x, tile_y, unit):
        ...
        neighbors = []
        for dx, dy in [(0, -1), (0, 1), (-1, 0), (1, 0)]:  # 90-degree moves
    ...
    def get_path(self, start_pos, target_pos, unit):
        """Find A* path from start_pos to target_pos or closest reachable point."""
        ...
        if cache_key in self.path_cache and self.path_cache[cache_key]['time'] == self.last_cache_clean:
        ...
        closest_distance = self.manhattan_distance(start_tile, target_tile)
        ...
        while open_set:
            ...
            for neighbor in self.get_neighbors(current[0], current[1], unit):
                ...
                if tentative_g < g_scores.get(neighbor, float('inf')):
                    ...
                    # Update closest tile
                    dist = self.manhattan_distance(neighbor, target_tile)
