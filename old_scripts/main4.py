...
pygame.display.set_caption("Simple RTS Game with Player Selection and FPS")
...
class Player:
    def __init__(self, player_id, color, start_x, start_y):
        ...
        self.units.extend([
            ...
            Barn(offset_x + 670, offset_y + 90, player_id)
        ])
...
while running:
    ...
    for i, player in enumerate(players):
        ...
        screen.blit(milk_text, (10, 40 + i * 30))  # Shifted down for FPS
    pygame.display.flip()
    clock.tick(60)
