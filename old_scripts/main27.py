...
GRID_BUTTON_ROWS = 3
GRID_BUTTON_COLS = 1
GRID_BUTTON_WIDTH = BUTTON_WIDTH - 40  # Changed from 120 to 110
GRID_BUTTON_HEIGHT = BUTTON_HEIGHT
GRID_BUTTON_MARGIN = BUTTON_MARGIN
GRID_BUTTON_START_X = VIEW_BOUNDS_X - GRID_BUTTON_WIDTH - BUTTON_MARGIN  # Updated for new width
...
# Scale icons
wood_icon = pygame.transform.scale(wood_icon, (20, 20))  # Changed from 24x24 to 20x20
milk_icon = pygame.transform.scale(milk_icon, (20, 20))  # Changed from 24x24 to 20x20
...
small_font = pygame.font.SysFont(None, 16)  # Kept at 16
