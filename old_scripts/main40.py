                ...
                # Check grid buttons for spawning
                    ...
                    if barn_selected:
                        if grid_buttons[0][0].collidepoint(event.pos):
                            ...
                            if current_player.milk >= Cow.milk_cost and current_player.wood >= Cow.wood_cost:
    ...
    for row in range(GRID_BUTTON_ROWS):
        for col in range(GRID_BUTTON_COLS):
            ...
            if barn_selected and current_player and row == 0 and col == 0:
                ...
                if row == 0 and col == 0:
                    spawn_button_color = HIGHLIGHT_GRAY if current_player.milk >= Barn.milk_cost and current_player.wood >= Barn.wood_cost else GRAY
                    pygame.draw.rect(screen, spawn_button_color, button_rect)
                    ...
                    spawn_button_color = HIGHLIGHT_GRAY if current_player.milk >= Barracks.milk_cost and current_player.wood >= Barracks.wood_cost else GRAY
                    pygame.draw.rect(screen, spawn_button_color, button_rect)
                    ...
                    spawn_button_color = HIGHLIGHT_GRAY if current_player.milk >= TownCenter.milk_cost and current_player.wood >= TownCenter.wood_cost else GRAY
                    pygame.draw.rect(screen, spawn_button_color, button_rect)
