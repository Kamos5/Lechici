...
GRID_BUTTON_ROWS = 3
GRID_BUTTON_COLS = 1
GRID_BUTTON_WIDTH = BUTTON_WIDTH
GRID_BUTTON_HEIGHT = BUTTON_HEIGHT
GRID_BUTTON_MARGIN = BUTTON_MARGIN
...
milk_icon = pygame.transform.scale(milk_icon, (ICON_SIZE * 3 // 4, ICON_SIZE * 3 // 4))
...
class Player:
    def __init__(self, player_id, color, start_x, start_y):
        ...
        self.milk = 0.0
        self.max_milk = 1000
        self.wood = 1000.0  # Temporary for testing Archer and Knight spawning
        self.max_wood = 1000
        self.units = []
        self.cow_in_barn = {}
        self.barns = []
...
while running:
        ...
        if event.type == pygame.QUIT:
            ...
            if event.button == 1:
                ...
                if VIEW_MARGIN_LEFT <= mouse_pos.x <= VIEW_BOUNDS_X and VIEW_MARGIN_TOP <= mouse_pos.y <= VIEW_BOUNDS_Y:
                    ...
                    for player in players:
                        player.deselect_all_units()
                elif barn_selected and current_player and current_player.milk >= Cow.milk_cost and current_player.wood >= Cow.wood_cost and grid_buttons[0][0].collidepoint(event.pos):
    ...
    for row in range(GRID_BUTTON_ROWS):
        for col in range(GRID_BUTTON_COLS):
            ...
            if barn_selected and current_player and row == 0 and col == 0:
                # Draw spawn cow button in top cell
                if current_player.milk >= Cow.milk_cost and current_player.wood >= Cow.wood_cost:
                    spawn_button_color = HIGHLIGHT_GRAY
                else:
                    spawn_button_color = GRAY
                pygame.draw.rect(screen, spawn_button_color, button_rect)
                screen.blit(Unit._unit_icons.get('Cow'), (button_rect.x + 10, button_rect.y + 5))
                spawn_cow_food_text = small_font.render(f"{Cow.milk_cost}", True, BLACK)
                spawn_cow_wood_text = small_font.render(f"{Cow.wood_cost}", True, BLACK)
                screen.blit(milk_icon, (button_rect.x + 50, button_rect.y))
                screen.blit(spawn_cow_food_text, (button_rect.x + 80, button_rect.y + 7))
                screen.blit(wood_icon, (button_rect.x + 50, button_rect.y + 15))
                screen.blit(spawn_cow_wood_text, (button_rect.x + 80, button_rect.y + 22))
            elif barracks_selected and current_player:
                # Draw spawn buttons for Axeman, Archer, Knight
                if row == 0 and col == 0:
                    # Axeman button
                    if current_player.milk >= Axeman.milk_cost and current_player.wood >= Axeman.wood_cost:
                        ...
                        spawn_button_color = GRAY
                    pygame.draw.rect(screen, spawn_button_color, button_rect)
                    screen.blit(Unit._unit_icons.get('Axeman'), (button_rect.x + 10, button_rect.y + 5))
                    spawn_cow_food_text = small_font.render(f"{Axeman.milk_cost}", True, BLACK)
                    spawn_cow_wood_text = small_font.render(f"{Axeman.wood_cost}", True, BLACK)
                    screen.blit(milk_icon, (button_rect.x + 50, button_rect.y))
                    screen.blit(spawn_cow_food_text, (button_rect.x + 80, button_rect.y + 7))
                    screen.blit(wood_icon, (button_rect.x + 50, button_rect.y + 15))
                    screen.blit(spawn_cow_wood_text, (button_rect.x + 80, button_rect.y + 22))
                    ...
                    if current_player.milk >= Archer.milk_cost and current_player.wood >= Archer.wood_cost:
                        ...
                        spawn_button_color = GRAY
                    pygame.draw.rect(screen, spawn_button_color, button_rect)
                    screen.blit(Unit._unit_icons.get('Archer'), (button_rect.x + 10, button_rect.y + 5))
                    spawn_cow_food_text = small_font.render(f"{Archer.milk_cost}", True, BLACK)
                    spawn_cow_wood_text = small_font.render(f"{Archer.wood_cost}", True, BLACK)
                    screen.blit(milk_icon, (button_rect.x + 50, button_rect.y))
                    screen.blit(spawn_cow_food_text, (button_rect.x + 80, button_rect.y + 7))
                    screen.blit(wood_icon, (button_rect.x + 50, button_rect.y + 15))
                    screen.blit(spawn_cow_wood_text, (button_rect.x + 80, button_rect.y + 22))
                    ...
                    if current_player.milk >= Knight.milk_cost and current_player.wood >= Knight.wood_cost:
                        ...
                        spawn_button_color = GRAY
                    pygame.draw.rect(screen, spawn_button_color, button_rect)
                    screen.blit(Unit._unit_icons.get('Knight'), (button_rect.x + 10, button_rect.y + 5))
                    spawn_cow_food_text = small_font.render(f"{Knight.milk_cost}", True, BLACK)
                    spawn_cow_wood_text = small_font.render(f"{Knight.wood_cost}", True, BLACK)
                    screen.blit(milk_icon, (button_rect.x + 50, button_rect.y))
                    screen.blit(spawn_cow_food_text, (button_rect.x + 80, button_rect.y + 7))
                    screen.blit(wood_icon, (button_rect.x + 50, button_rect.y + 15))
                    screen.blit(spawn_cow_wood_text, (button_rect.x + 80, button_rect.y + 22))
    ...
    if current_player:
        ...
        screen.blit(resources_text, (VIEW_MARGIN_LEFT + 150, 15))
