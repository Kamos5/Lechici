...
from units import Building, Barn, Barracks, TownCenter, Axeman, Archer, Knight, Cow, ShamansHut, WarriorsLodge, KnightsEstate, Wall
...
def execute_grid_cell(
    ...
    *,
    ...
    # world objects (e.g., Road): start placement, DO NOT deduct yet
